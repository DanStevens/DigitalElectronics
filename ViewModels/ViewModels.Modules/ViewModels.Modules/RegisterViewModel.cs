...
public class RegisterViewModel : INotifyPropertyChanged, IRegisterViewModel
{
    ...
    public RegisterViewModel(int wordSize)
        : this(new Register(wordSize))
    { }

    public RegisterViewModel(IReadWriteRegister register)
    {
    ...
    public int WordSize => _register.WordSize;
